    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					System.out.println("** 1.)BANGALORE     | Php600 |   "+available[1]+"   **");
    					System.out.println("** 2.)HYDERABAD     | Php870 |   "+available[2]+"   **");
    					System.out.println("** 3.)CHENNAI       | Php150 |   "+available[3]+"   **");
					...
					System.out.println("***************************************\n");
    					...
    					String dest[] = { " ", "BANGALORE", "HYDERABAD", "CHENNAI", "MYSORE", "VADODARA"};
    					double fare[] = { 0,600,870,150,500,1050};
